...
from {{cookiecutter.directory_name}}.items import Item

from  dateutil.parser import parse as fromisoformat

class {{cookiecutter.directory_name}}Spider(CrawlSpider):
    name = '{{cookiecutter.directory_name}}_spider'
    allowed_domains = ['{{cookiecutter.url}}']
    start_urls = ['http://{{cookiecutter.url}}']
